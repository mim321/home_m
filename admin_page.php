...
<div class="w3-panel w3-teal w3-card-4">
        ...
        <p>ยินดีต้องรับเข้าสู่หน้า Admin</p>
</div>
	</form>
...
<button class="w3-button w3-purple w3-round-large">where ใน sql</button>
</form></p>
<form action="logout.php">	
<button class="w3-button w3-purple w3-round-large">ออกจากระบบ... </button>
</form>
