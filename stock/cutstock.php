...
//Set ว/ด/ป เวลา ให้เป็นของประเทศไทย
 ...
 $query1 = mysql_db_query($database_dbfreshcoffee, $sql1) or die ("Error in query: $sql1 " . mysql_error());
 
  
 
 
 $sql2 = "SELECT MAX(order_id) AS order_id FROM tb_order  WHERE member_phone='$member_phone'";
 $query2 = mysql_db_query($database_dbfreshcoffee, $sql2);
  ...
  
 {
  ...
  $query3 = mysql_db_query($database_dbfreshcoffee, $sql3);
  ...
  '$p_qty', 
  '$total')";
  $query4 = mysql_db_query($database_dbfreshcoffee, $sql4);
